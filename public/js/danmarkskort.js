...
.dk-hud-title {
  ...
  color: #d4af37; text-transform: uppercase; opacity: 0.9;
}
...
.dk-legend {
  background: rgba(0,0,0,0.75); border: 1px solid rgba(212,175,55,0.2);
  padding: 7px 10px; border-radius: 3px;
}
.dk-legend-inner { display: flex; align-items: flex-end; gap: 4px; }
...
.dk-leg-lbl {
  font-family: "Courier New", Courier, monospace;
  font-size: 8px; color: rgba(212,175,55,0.7);
}
.dk-stats {
...
.dk-tooltip {
  ...
  background: rgba(0,0,0,0.88); border: 1px solid rgba(212,175,55,0.5);
  color: #e8e8e8; font-size: 12px; padding: 10px 13px;
  border-radius: 4px; pointer-events: none; max-width: 240px;
  font-family: "Courier New", Courier, monospace;
}
.dkt-title {
...
.dkt-highlight {
  font-size: 11px; color: #aaa; margin-bottom: 7px;
}
...
.dkt-k { color: rgba(255,255,255,0.55); }
.dkt-v { color: rgba(255,255,255,0.9); text-align: right; }
.dk-loading {
  position: absolute; inset: 0; z-index: 30;
  display: flex; align-items: center; justify-content: center;
  background: rgba(0,0,0,0.9); flex-direction: column; gap: 14px;
}
.dk-loading-text {
  font-family: "Courier New", Courier, monospace;
...
.dk-loading-sub {
  font-family: "Courier New", Courier, monospace;
  font-size: 10px; color: rgba(212,175,55,0.5); letter-spacing: 1px;
}
@keyframes dkBlink {
